...
registrosorigen = campos_cursor.rowcount
print("(4) tabla FormaPagoPersonal")
print(registrosorigen)
...
#SELECT NumSol, Cantidad, Descripcion, Valor, Sub_Total, Tipo, Codigo, Stock, Unidad, Requerida, Saldo, NFichaExp, tmpFecODC, tmpFecEntrega, tmpNumODC, tmpCantRec, tmpRutProve, tmpFecRec, tmpCantODC, NLinea, Observacion, CodMotivoSol, TieneODC, CodServicio FROM detallesolicitud;
# TABLA detalleliquidacion
i = 0
campos_cursor.execute('SELECT `NumSol`, `Cantidad`, `Describe`, `Valor`, `Sub_Total`, `Tipo`, `Codigo`, `Stock`, `Unidad`, `Requerida`, `Saldo`, `NFichaExp`, `tmpFecODC`, `tmpFecEntrega`, `tmpNumODC`, `tmpCantRec`, `tmpRutProve`, `tmpFecRec`, `tmpCantODC`, `NLinea`, `Observacion`, `CodMotivoSol`, `TieneODC`, `CodServicio` FROM `DetalleSolicitud`')
registrosorigen = campos_cursor.rowcount
print("(4) tabla detallesolicitud")
print(registrosorigen)
for NumSol, Cantidad, Descripcion, Valor, Sub_Total, Tipo, Codigo, Stock, Unidad, Requerida, Saldo, NFichaExp, tmpFecODC, tmpFecEntrega, tmpNumODC, tmpCantRec, tmpRutProve, tmpFecRec, tmpCantODC, NLinea, Observacion, CodMotivoSol, TieneODC, CodServicio in campos_cursor.fetchall():
    ...
    sql = "INSERT INTO " + EsquemaBD + ".detallesolicitud(NumSol, Cantidad, Descripcion, Valor, Sub_Total, Tipo, Codigo, Stock, Unidad, Requerida, Saldo, NFichaExp, tmpFecODC, tmpFecEntrega, tmpNumODC, tmpCantRec, tmpRutProve, tmpFecRec, tmpCantODC, NLinea, Observacion, CodMotivoSol, TieneODC, CodServicio) " \
...
#SELECT `CodMes`, `CodPer`, `CodLabor`, `Tarifa`, `Dias`, `Folio`, `CodPeriodo` FROM `DetalleTratosTarifa`
# TABLA DetalleTratosTarifa
i = 0
campos_cursor.execute('SELECT `CodMes`, `CodPer`, `CodLabor`, `Tarifa`, `Dias`, `Folio`, `CodPeriodo` FROM DetalleTratosTarifa')
registrosorigen = campos_cursor.rowcount
print("(4) tabla DetalleTratosTarifa")
print(registrosorigen)
for CodMes, CodPer, CodLabor, Tarifa, Dias, Folio, CodPeriodo in campos_cursor.fetchall():
    ...
    sql = "INSERT INTO " + EsquemaBD + ".DetalleTratosTarifa(CodMes, CodPer, CodLabor, Tarifa, Dias, Folio, CodPeriodo) " \
...
#SELECT `CodEnc`, `NomEnc`, `CorreoEnc`, `CodFundo`, `Dominio`, `ClaveCorreo` FROM `Encargado`
# TABLA Encargado
i = 0
campos_cursor.execute('SELECT `CodEnc`, `NomEnc`, `CorreoEnc`, `CodFundo`, `Dominio`, `ClaveCorreo` FROM `Encargado`')
registrosorigen = campos_cursor.rowcount
print("(4) tabla Encargado")
print(registrosorigen)
...
#SELECT `CodProd`, `CodImple`, `BdgCodigo`, `Existencia`, `NumExportacion`, `Fisico`, `Diferencia`, `Inventario` FROM `ExistenciaBodega`
# TABLA ExistenciaBodega
i = 0
campos_cursor.execute('SELECT `CodProd`, `CodImple`, `BdgCodigo`, `Existencia`, `NumExportacion`, `Fisico`, `Diferencia`, `Inventario` FROM `ExistenciaBodega`')
registrosorigen = campos_cursor.rowcount
print("(4) tabla ExistenciaBodega")
print(registrosorigen)
for CodProd, CodImple, BdgCodigo, Existencia, NumExportacion, Fisico, Diferencia, Inventario in campos_cursor.fetchall():
    ...
    sql = "INSERT INTO " + EsquemaBD + ".ExistenciaBodega(CodProd, CodImple, BdgCodigo, Existencia, NumExportacion, Fisico, Diferencia, Inventario) " \
...
#SELECT `NumFC`, `FechaFC`, `CodProv`, `CodigoFC`, `NetoFC`, `IvaFC`, `TotalFC`, `NumODC`, `CodBod`, `GlosaFC`, `TipoDoc`, `CodMon`, `TasaFC`, `DescuentoFC`, `RebajaExistenciaFC`, `ExentaFC`, `AbonosFC`, `SaldoFC`, `EstadoFC`, `FechaVenceFC`, `CodOper`, `CodCC`, `FechaContabilizaFC`, `MontoImpEspNoRecFC`, `OtrosImpuestosFC`, `NumPeriodo`, `MueveExistencia`, `Desde_Campos`, `MontoImpEspRecFC`, `MixtaFC`, `NumExportacion`, `NumFolio`, `NumSolEgreso`, `PorcDescuentoFC`, `ConCuarteles`, `FechaIngreso`, `FueContabilizada`, `ConNota`, `NetoFCNota`, `IvaFCNota`, `TotalFCNota`, `MontoAfectoFC`, `MontoExentoFC`, `EsTercero`, `Retencion`, `OperacionCtbleFC`, `ExentoFCNota`, `AfectoFCNota`, `FechaRecepcionFC`, `DiferenciaPrecio`, `CentralizadaCons`, `DigitadaPor`, `EsContratista`, `CodCondPago` FROM `FacturaCompra`
# TABLA FacturaCompra
i = 0
campos_cursor.execute('SELECT `NumFC`, `FechaFC`, `CodProv`, `CodigoFC`, `NetoFC`, `IvaFC`, `TotalFC`, `NumODC`, `CodBod`, `GlosaFC`, `TipoDoc`, `CodMon`, `TasaFC`, `DescuentoFC`, `RebajaExistenciaFC`, `ExentaFC`, `AbonosFC`, `SaldoFC`, `EstadoFC`, `FechaVenceFC`, `CodOper`, `CodCC`, `FechaContabilizaFC`, `MontoImpEspNoRecFC`, `OtrosImpuestosFC`, `NumPeriodo`, `MueveExistencia`, `Desde_Campos`, `MontoImpEspRecFC`, `MixtaFC`, `NumExportacion`, `NumFolio`, `NumSolEgreso`, `PorcDescuentoFC`, `ConCuarteles`, `FechaIngreso`, `FueContabilizada`, `ConNota`, `NetoFCNota`, `IvaFCNota`, `TotalFCNota`, `MontoAfectoFC`, `MontoExentoFC`, `EsTercero`, `Retencion`, `OperacionCtbleFC`, `ExentoFCNota`, `AfectoFCNota`, `FechaRecepcionFC`, `DiferenciaPrecio`, `CentralizadaCons`, `DigitadaPor`, `EsContratista`, `CodCondPago` FROM `FacturaCompra`')
registrosorigen = campos_cursor.rowcount
print("(4) tabla FacturaCompra")
print(registrosorigen)
for NumFC, FechaFC, CodProv, CodigoFC, NetoFC, IvaFC, TotalFC, NumODC, CodBod, GlosaFC, TipoDoc, CodMon, TasaFC, DescuentoFC, RebajaExistenciaFC, ExentaFC, AbonosFC, SaldoFC, EstadoFC, FechaVenceFC, CodOper, CodCC, FechaContabilizaFC, MontoImpEspNoRecFC, OtrosImpuestosFC, NumPeriodo, MueveExistencia, Desde_Campos, MontoImpEspRecFC, MixtaFC, NumExportacion, NumFolio, NumSolEgreso, PorcDescuentoFC, ConCuarteles, FechaIngreso, FueContabilizada, ConNota, NetoFCNota, IvaFCNota, TotalFCNota, MontoAfectoFC, MontoExentoFC, EsTercero, Retencion, OperacionCtbleFC, ExentoFCNota, AfectoFCNota, FechaRecepcionFC, DiferenciaPrecio, CentralizadaCons, DigitadaPor, EsContratista, CodCondPago in campos_cursor.fetchall():
    ...
    sql = "INSERT INTO " + EsquemaBD + ".FacturaCompra(NumFC, FechaFC, CodProv, CodigoFC, NetoFC, IvaFC, TotalFC, NumODC, CodBod, GlosaFC, TipoDoc, CodMon, TasaFC, DescuentoFC, RebajaExistenciaFC, ExentaFC, AbonosFC, SaldoFC, EstadoFC, FechaVenceFC, CodOper, CodCC, FechaContabilizaFC, MontoImpEspNoRecFC, OtrosImpuestosFC, NumPeriodo, MueveExistencia, Desde_Campos, MontoImpEspRecFC, MixtaFC, NumExportacion, NumFolio, NumSolEgreso, PorcDescuentoFC, ConCuarteles, FechaIngreso, FueContabilizada, ConNota, NetoFCNota, IvaFCNota, TotalFCNota, MontoAfectoFC, MontoExentoFC, EsTercero, Retencion, OperacionCtbleFC, ExentoFCNota, AfectoFCNota, FechaRecepcionFC, DiferenciaPrecio, CentralizadaCons, DigitadaPor, EsContratista, CodCondPago) " \
...
#SELECT `CodLabMaq`, `CodFaena` FROM `FaenaLabMaq`
# TABLA FaenaLabMaq
i = 0
campos_cursor.execute('SELECT CodLabMaq, CodFaena FROM FaenaLabMaq')
registrosorigen = campos_cursor.rowcount
print("(4) tabla FaenaLabMaq")
print(registrosorigen)
...
#SELECT `CodLabor`, `CodFaena` FROM `FaenaLabor`
# TABLA FaenaLabMaq
i = 0
campos_cursor.execute('SELECT CodLabor, CodFaena FROM FaenaLabor')
registrosorigen = campos_cursor.rowcount
print("(4) tabla FaenaLabor")
print(registrosorigen)
...
#SELECT `CodFam`, `NomFam`, `TipoFam`, `CodCtaCtble`, `TotalFam` FROM `Familias`
# TABLA Familias
i = 0
campos_cursor.execute('SELECT CodFam, NomFam, TipoFam, CodCtaCtble, TotalFam FROM Familias')
registrosorigen = campos_cursor.rowcount
print("(4) tabla Familias")
print(registrosorigen)
...
for MesFeriado, FechaFeriado, AgnoFeriado, DiaFeriado, FechaIngreso in campos_cursor.fetchall():
    ...
    sql = "INSERT INTO " + EsquemaBD + ".File36(MesFeriado, FechaFeriado, AgnoFeriado, DiaFeriado, FechaIngreso) " \
                                        "VALUES (%s, %s, %s, %s, %s)"
...
#SELECT `CodPer`, `Bonos`, `Haberes`, `HorasExtras`, `Tratos`, `DesglosePrest`, `DesgloseDcto`, `DesgloseLab`, `Colacion`, `Movilizacion` FROM `FormatoLiqui`
#TABLA FormatoLiqui
i = 0
campos_cursor.execute('SELECT CodPer, Bonos, Haberes, HorasExtras, Tratos, DesglosePrest, DesgloseDcto, DesgloseLab, Colacion, Movilizacion FROM FormatoLiqui')
registrosorigen = campos_cursor.rowcount
print("(4) tabla FormatoLiqui")
print(registrosorigen)
for CodPer, Bonos, Haberes, HorasExtras, Tratos, DesglosePrest, DesgloseDcto, DesgloseLab, Colacion, Movilizacion in campos_cursor.fetchall():
    ...
    sql = "INSERT INTO " + EsquemaBD + ".FormatoLiqui(CodPer, Bonos, Haberes, HorasExtras, Tratos, DesglosePrest, DesgloseDcto, DesgloseLab, Colacion, Movilizacion) " \
...
#SELECT `CodFundo`, `NomFundo`, `CodPredio`, `HectFundo`, `RazonFundo`, `UnicoFundo`, `DomFundo`, `CiuFundo`, `RutFundo`, `NoProductivo`, `CodCC`, `LugarTrabajoRem700`, `DiasAdicVac`, `HoraInicioAM`, `HoraTerminoAM`, `HoraInicioPM`, `HoraTerminoPM`, `HoraInicioAMSab`, `HoraTerminoAMSab`, `HoraInicioPMSab`, `HoraTerminoPMSab`, `FolioLibroAsist` FROM `Fundos`
#TABLA Fundos
i = 0
campos_cursor.execute('SELECT CodFundo, NomFundo, CodPredio, HectFundo, RazonFundo, UnicoFundo, DomFundo, CiuFundo, RutFundo, NoProductivo, CodCC, LugarTrabajoRem700, DiasAdicVac, HoraInicioAM, HoraTerminoAM, HoraInicioPM, HoraTerminoPM, HoraInicioAMSab, HoraTerminoAMSab, HoraInicioPMSab, HoraTerminoPMSab, FolioLibroAsist FROM Fundos')
registrosorigen = campos_cursor.rowcount
print("(4) tabla Fundos")
print(registrosorigen)
for CodFundo, NomFundo, CodPredio, HectFundo, RazonFundo, UnicoFundo, DomFundo, CiuFundo, RutFundo, NoProductivo, CodCC, LugarTrabajoRem700, DiasAdicVac, HoraInicioAM, HoraTerminoAM, HoraInicioPM, HoraTerminoPM, HoraInicioAMSab, HoraTerminoAMSab, HoraInicioPMSab, HoraTerminoPMSab, FolioLibroAsist in campos_cursor.fetchall():
    ...
    sql = "INSERT INTO " + EsquemaBD + ".Fundos(CodFundo, NomFundo, CodPredio, HectFundo, RazonFundo, UnicoFundo, DomFundo, CiuFundo, RutFundo, NoProductivo, CodCC, LugarTrabajoRem700, DiasAdicVac, HoraInicioAM, HoraTerminoAM, HoraInicioPM, HoraTerminoPM, HoraInicioAMSab, HoraTerminoAMSab, HoraInicioPMSab, HoraTerminoPMSab, FolioLibroAsist) " \
...
#SELECT `CodigoFC`, `FechaGuia`, `CodCom`, `NumFC`, `NumGuia`, `Desvincular` FROM `GuiaFactCpra`
#TABLA GuiaFactCpra
i = 0
campos_cursor.execute('SELECT CodigoFC, FechaGuia, CodCom, NumFC, NumGuia, Desvincular FROM GuiaFactCpra')
registrosorigen = campos_cursor.rowcount
print("(4) tabla GuiaFactCpra")
print(registrosorigen)
